...
function VideoSection() {
  return (
    <div className="relative max-w-5xl mx-auto rounded-2xl overflow-hidden shadow-2xl shadow-green-500/10 mb-8 sm:mb-0">
      <video
        src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/ActionverseMap-X2vlFXGmLI0p26TiezQ7Evzk1GlmAf.webm"
        autoPlay
        loop
        muted
        playsInline
    ...
    <section className="py-12 sm:py-20 md:py-32 max-w-6xl mx-auto">
      <div className="text-center mb-12 sm:mb-16 px-4">
        ...
        <p className="text-lg sm:text-xl text-green-400 mb-6">
          Place Bounties, Inspire Giving, Create Real-World Impact
        </p>
        <p className="text-base sm:text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed">
          Organizations can place digital pins, challenges, and bounties at real-world locations to inspire positive
          actions. Whether it&apos;s encouraging donations to charities, volunteering at community centers, or completing
          meaningful tasks — users explore the map, navigate to locations, take action, and prove their impact to claim
        ...
        <div className="mt-8 bg-gradient-to-br from-green-900/40 to-gray-900/50 border border-green-700/50 rounded-lg p-4 sm:p-6 max-w-3xl mx-auto">
          <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
            <span className="font-semibold text-green-400">Example:</span> A nonprofit places a pin at their location
            with a bounty requiring a $20 donation. Users visit the location, make the donation, and prove it by
            collecting the pin while physically there or by uploading a receipt. Once verified, they claim tokens as a
            reward for their positive action.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          <div className="bg-gradient-to-br from-purple-900/30 to-gray-900/50 border border-purple-700/50 rounded-lg p-4 sm:p-6">
            ...
            <p className="text-sm sm:text-base text-gray-300 mb-4">
              Sign up and start placing bounties, challenges, and scavenger hunts on the map. Drop pins at real-world
              locations with tasks, rewards, and time limits.
            </p>
          ...
          <div className="bg-gradient-to-br from-blue-900/30 to-gray-900/50 border border-blue-700/50 rounded-lg p-4 sm:p-6">
            ...
            <p className="text-sm sm:text-base text-gray-300 mb-4">
              Explore the interactive map, find bounties near you, navigate to locations, complete challenges, and claim
              your rewards instantly on the blockchain.
            </p>
            <ul className="text-sm text-gray-400 space-y-2">
          ...
          <div className="bg-gradient-to-br from-green-900/30 to-gray-900/50 border border-green-700/50 rounded-lg p-4 sm:p-6">
            ...
            <p className="text-sm sm:text-base text-gray-300">
              Organizations can place bounties for specific work, challenges, or tasks at physical locations. Set
              requirements, rewards, and deadlines — users complete them and get paid.
            </p>
          </div>
          <div className="bg-gradient-to-br from-yellow-900/30 to-gray-900/50 border border-yellow-700/50 rounded-lg p-4 sm:p-6">
            ...
            <p className="text-sm sm:text-base text-gray-300">
              Create multi-location scavenger hunts where users must visit specific places in order, solve puzzles, or
              find hidden AR objects to unlock the final reward.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="bg-gradient-to-br from-pink-900/30 to-gray-900/50 border border-pink-700/50 rounded-lg p-4 sm:p-6">
            ...
            <p className="text-sm text-gray-300">
              Nonprofits place pins at their locations requiring donations or volunteer hours. Users prove their
              contribution with receipts or by checking in physically, then claim reward tokens for their positive
              impact.
            </p>
          </div>
          <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4 sm:p-6">
            ...
            <p className="text-sm text-gray-300">
              Place promotional bounties at store locations. Reward customers who visit, scan QR codes, or complete
              actions with tokens or discounts.
            </p>
          </div>
          <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4 sm:p-6">
            <h4 className="text-base sm:text-lg font-semibold mb-2 text-blue-400">Event Engagement</h4>
            <p className="text-sm text-gray-300">
              Create scavenger hunts for conferences, festivals, or trade shows. Guide attendees to booths, sessions, or
              hidden locations for rewards.
            </p>
          </div>
          <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4 sm:p-6">
            <h4 className="text-base sm:text-lg font-semibold mb-2 text-yellow-400">Community Building</h4>
            <p className="text-sm text-gray-300">
              DAOs and communities can place bounties for real-world tasks like cleanup events, volunteer work, or local
              meetups.
            </p>
          </div>
          <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4 sm:p-6">
            ...
            <p className="text-sm text-gray-300">
              Post location-based bounties for tasks like photography, deliveries, inspections, or research at specific
              places.
            </p>
          </div>
          <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4 sm:p-6">
            ...
            <p className="text-sm text-gray-300">
              Create educational scavenger hunts at museums, historical sites, or campuses. Reward learners for
              exploring and engaging with knowledge.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="text-center px-4">
        ...
        <p className="text-base sm:text-lg text-gray-300 mb-6 sm:mb-8 max-w-2xl mx-auto">
          Whether you&apos;re just getting started or already leading a community — we&apos;ll help you launch, scale, and
          reward action.
        </p>
